    ...
    return (
        <div className="p-8 space-y-8 min-h-screen bg-zinc-950 text-white">
            <div>
                ...
                <p className="text-zinc-400 mt-2">A record of your completed projects and contributions.</p>
            </div>
            ...
            {projects.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-12 border border-dashed border-zinc-800 rounded-xl bg-zinc-900/50">
                    ...
                    <h3 className="text-lg font-medium text-zinc-300">No completed projects yet</h3>
                    <p className="text-zinc-500 text-sm mt-1">Once you finish tasks, they will appear here.</p>
                </div>
            ) : (
                <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 overflow-hidden">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-zinc-900 text-zinc-400 uppercase font-medium border-b border-zinc-800">
                            <tr>
